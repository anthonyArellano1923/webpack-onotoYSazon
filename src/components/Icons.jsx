/**
 * @fileoverview Set de iconos SVG como componentes React.
 *
 * Cada icono es un componente funcional que acepta una prop `size`
 * y renderiza un SVG inline. Se usan en toda la interfaz: navegación,
 * tarjetas de menú, modales, botones de acción flotantes y contacto.
 *
...
export const IconXLogo = ({ size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
/**
 * Mapa de nombres de icono a componentes, para uso dinámico
 * desde los datos de socials.js (campo `icon`).
 */
